...
import mosqueImage from "../../assets/mosque-white.svg";

const Message = () => {
  return (
    <div className="w-[340px] h-[315px] bg-[#34AB82] text-white p-4 rounded-lg mt-6 relative mx-auto">
      {/*content  */}
      <div>
