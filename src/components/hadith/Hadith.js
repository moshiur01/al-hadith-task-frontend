          ...
          >
            <div className="flex justify-between items-center">
              ...
              <p className="lg:hidden">
                <span className="px-2 py-1 bg-[#46B891] text-white text-sm font-medium rounded-lg font-bangla-v2">
                  {hadith?.grade}
                </span>
              </p>
            </div>
            ...
            <div className=" ">
              ...
              <p className=" tracking-wider text-base pb-8">{hadith?.bn}</p>
            </div>
            <div className="flex justify-center items-center py-4 border-t-[1px] lg:justify-between lg:py-8 lg:border-t-0">
              <div>
